      ...
      {!attempting && (
        <ContentWrapper gap="lg">
          <ModalUpper>
            ...
            <CardSection gap="md">
              <RowBetween>
                <ThemedText.DeprecatedWhite fontWeight={500}>Faucet of Test Coins</ThemedText.DeprecatedWhite>
          ...
          <AutoColumn gap="md" style={{ padding: '1rem', paddingTop: '0', paddingBottom: '0' }} justify="start">
            ...
            <ThemedText.DeprecatedSubHeader fontWeight={500}>
              Get test BTC USDT for DApp testing, test coins are no practical value on Aptos DevNet.
            </ThemedText.DeprecatedSubHeader>
          </AutoColumn>
